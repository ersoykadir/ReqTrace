...
artifact_template = {"issues": ISSUE_queryTemplate, "pullRequests": PR_queryTemplate}
...
def get_all_pages(artifact_type, repo_owner, repo_name):
    ...
    while has_next_page:
        ...
        query = template.substitute(owner=repo_owner, name=repo_name, cursor=end_cursor)
...
def get_requirements(req_file_data):
    ...
    for match in matches:
        ...
        req_dict = {"number": req_number, "description": req_description}
